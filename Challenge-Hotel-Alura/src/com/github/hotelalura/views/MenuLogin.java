...
import com.github.hotelalura.jdbc.FactoryConnection;
...
public class MenuLogin extends JFrame {
	...
	public MenuLogin() {
		...
		contentPanel.add(loginTitle("USU�RIO", 219));
		
		txtUser = new JTextField();
		txtUser.setText("Digite seu nome de usu�rio");
		txtUser.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				if(txtUser.getText().equals("Digite seu nome de usu�rio")) {
					txtUser.setText("");
