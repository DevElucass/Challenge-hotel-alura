...
public class MenuUser extends JFrame {
	...
	public MenuUser() {
		...
		lblSection.setText("Hoje � " + new SimpleDateFormat("dd/MM/yyyy").format(new Date()));
		...
		contentPanel.add(lblDescription(
				"<html><body>Sistema de reservas de hot�is. Controle e gerencie de forma otimizada e f�cil<br>"
				+ "o fluxo de reservas e h�spedes do hotel</body></html>", 291, 598, 66));
		contentPanel.add(lblDescription(
				"<html><body>Esta ferramenta permitir� que voc� mantenha um contro completo "
				+ "e detalhado de suas reservas e h�spedes, voc� ter� acesso a ferramentas "
				+ "especiais para tarefas como:</body></html>", 345, 569, 88));
		contentPanel.add(lblDescription(
				" - Registro de Reservas e H�spedes", 444, 295, 27));
		contentPanel.add(lblDescription(
				" - Edi��o de Reservas e H�spedes existentes", 482, 355, 27));
		contentPanel.add(lblDescription(
